 ...
 * @author Maycon
 */
public class viewAltPesquisaCidTransp extends javax.swing.JInternalFrame {
     ...
     */
    public viewAltPesquisaCidTransp() {
        initComponents();
        carregarCidades();
    }
    ...
    private void jtbCidadesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbCidadesMouseClicked
        ...
        viewAltTransp.jtfIdCidade.setText(String.valueOf(id));
        viewAltTransp.jtfNomeCidade.setText(String.valueOf(cidade));
        dispose();
