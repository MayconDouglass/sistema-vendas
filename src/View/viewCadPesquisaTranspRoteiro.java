 ...
 * @author Maycon
 */
public class viewCadPesquisaTranspRoteiro extends javax.swing.JInternalFrame {
     ...
     */
    public viewCadPesquisaTranspRoteiro() {
        initComponents();
    ...
    private void jtbTranspMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbTranspMouseClicked
        ...
        viewCadRoteiro.jtfIdTransp.setText(String.valueOf(id));
        viewCadRoteiro.jtfNomeTransp.setText(String.valueOf(cidade));
        dispose();
