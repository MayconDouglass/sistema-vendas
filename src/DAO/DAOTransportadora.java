    ...
    public boolean atualizarTransportadoraDAO(ModelTransportadora pModelTransportadora) {
        try {
            ...
            return this.executarUpdateDeleteSQL(
                    ...
                    + "transp_fone_1 = '" + pModelTransportadora.getTranspFone1() + "',"
                    + "transp_fone_2 = '" + pModelTransportadora.getTranspFone2() + "',"
                    + "transp_fone_3 = '" + pModelTransportadora.getTranspFone3() + "',"
                    ...
                    + "transp_placauf = '" + pModelTransportadora.getTranspPlacauf() + "',"
